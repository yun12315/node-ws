...
const UUID = process.env.UUID || '8524354c-6ac9-442f-89a6-a4f0a9357e3c'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || '';       // 哪吒v1填写形式：nz.abc.com:8008   哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';           // 哪吒v1没有此变量，v0的agent端口为{443,8443,2096,2087,2083,2053}其中之一时开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || '';             // v1的NZ_CLIENT_SECRET或v0的agent端口                
const DOMAIN = process.env.DOMAIN || 'xiekai759.ggff.net';       // 填写项目域名或已反代的域名，不带前缀，建议填已反代的域名
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'xiekai759.xiekai759.ggff.net';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiZmU4M2ExZTkwZjFkNjgxMjE5NThkMDkyMTIzMzJmZmEiLCJ0IjoiYzgwMmMwZGYtNjYxYy00YTg1LWFkZDctYzQ3NmFiNTdlY2QxIiwicyI6IlpEZzFOR1kxTlRBdFpXWTJaQzAwTm1aaUxUZ3dOemt0TUdJNU5XWTBOelV4WWprMCJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://json.zone.id
